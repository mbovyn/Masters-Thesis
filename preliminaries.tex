...
% https://grad.uci.edu/academics/degree-programs/index.php
...
% Otherwise, this section may be omitted.
 \prepublishedcopyrightdeclaration
 {
	...
	Revised versions of chapter \ref{sec:maintext} and appendix \ref{sec:model} published in \cite{Bergman2018}, {\copyright} 2018 the authors. \\
...
% The abstract should not be over 350 words (250 for masters), 
% although that's supposedly somewhat of a soft constraint.
\thesisabstract
{
